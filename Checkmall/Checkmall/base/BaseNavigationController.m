...
#import "BaseViewController.h"//视图
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
     ...
     */
    //获取当前视图
    BaseViewController *vc =(BaseViewController*) self.viewControllers[self.viewControllers.count-1];

    return self.viewControllers.count != 1 && ![[self valueForKey:@"_isTransitioning"] boolValue] && vc.CeHua;
}
//
